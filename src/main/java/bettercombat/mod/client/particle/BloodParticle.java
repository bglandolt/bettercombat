...
public class BloodParticle extends ParticleDrip
{
    private int bobTimer;

    public BloodParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn)
    {
    	super(worldIn, xCoordIn, yCoordIn, zCoordIn, Material.AIR);
...
//            else
    ...
    @SideOnly(Side.CLIENT)
    public static class BloodFactory implements IParticleFactory
    {
        public Particle createParticle(int particleID, World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, int... p_178902_15_)
        {
            return new BloodParticle(worldIn, xCoordIn, yCoordIn, zCoordIn);
        }
    }
}
